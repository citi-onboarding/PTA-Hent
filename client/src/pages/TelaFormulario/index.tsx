...
export const TelaForm = () => {
    return(
        <Pag>
            ...
            <div style={{backgroundColor: "", position: "relative", top: "0", right:"0", width: "max-content", height: "max-content"}}>
                <img src={Poligono.src} style={{position: "absolute", zIndex:"-1"}}></img>
                <Formulario>
